...
// // // Assets (আপডেটেড: protfolio2 রিমুভ করা হয়েছে)
// // import protfolio from "../assets/Web Portfolio-01.jpg.jpeg";
// // import protfolio1 from "../assets/Web Portfolio-02.jpg.jpeg";
...
// //   // স্ক্রল লক করার প্রফেশনাল উপায়
// //   useEffect(() => {
// //     if (selectedProject) {
// //       document.body.style.overflow = "hidden";
// //     } else {
...
// //   // প্রজেক্ট লিস্ট (শুধু পাশাপাশি ২টা প্রজেক্ট রাখা হয়েছে)
// //   const projects = [
// //     {
// //       id: 1,
// //       title: "CLIKTRO",
...
// //       image: protfolio,
// //       gridSpan: "col-span-1",
// //       previews: [protfolio, protfolio1, protfolio, protfolio1], 
// //     },
// //     {
// //       id: 2,
// //       title: "Robotic Implant Center",
...
// //       image: protfolio1,
// //       gridSpan: "col-span-1",
// //       previews: [protfolio1, protfolio, protfolio1, protfolio],
// //     },
// //   ];
...
// //       {/* --- FIXED GORGEOUS MODAL (UPDATED WITH FULL-WIDTH IMAGES) --- */}
// //       <AnimatePresence>
// //         {selectedProject && (
// //           <motion.div 
// //             className="fixed inset-0 z-[9999] bg-white h-screen overflow-y-auto no-scrollbar scroll-smooth"
...
// //               {/* STYLISH FULL-WIDTH SHOWCASE GRID (TEXT REMOVED) */}
...
// //                     <div className="w-full rounded-2xl md:rounded-[2.5rem] overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.06)] border border-gray-100 bg-[#fbfbfb]">
// //                       <motion.img 
...
// // // Assets (আপডেটেড: protfolio2 রিমুভ করা হয়েছে)
// // import protfolio from "../assets/Web Portfolio-01.jpg.jpeg";
// // import protfolio1 from "../assets/Web Portfolio-02.jpg.jpeg";
// // import protfolio2 from "../assets/Web Portfolio-03.jpg.jpeg";
// // import protfolio3 from "../assets/Web Portfolio-04.jpg.jpg";
// // import protfolio4 from "../assets/Web Portfolio-05.jpg.jpg";
// // import protfolio5 from "../assets/Web Portfolio-06.jpg.jpg";
...
// //   // প্রজেক্ট লিস্ট (শুধু পাশাপাশি ২টা প্রজেক্ট রাখা হয়েছে)
// //   const projects = [
// //     {
// //       id: 1,
// //       title: "CLIKTRO",
...
// //             {/* 
// //               [গাইড - মডাল কন্টেইনার উইড্থ ও প্যাডিং]:
// //               ইমেজগুলোকে ডেস্কটপের দুই পাশে একদম কম স্পেসিং দিয়ে ফুল উইড্থ করার জন্য 'max-w-none' এবং দুই পাশের প্যাডিং কমিয়ে 'px-2 md:px-4' করা হয়েছে।
// //               প্রয়োজন হলে আপনি 'max-w-none' পরিবর্তন করে 'max-w-[95vw]' বা 'max-w-7xl' ব্যবহার করতে পারেন।
// //             */}
// //             <div className="w-full max-w-none px-2 md:px-4 pt-12 pb-32">
// //               {/* Intro Section - এটিকে দেখতে সুন্দর রাখার জন্য ভেতরে একটু ডানে-বামে প্যাডিং (px-4 md:px-12) বজায় রাখা হয়েছে */}
// //               <div className="mb-24 md:mb-32 max-w-7xl mx-auto px-4 md:px-12">
// //                 <motion.h2 
// //                   initial={{ opacity: 0, y: 30 }}
// //                   animate={{ opacity: 1, y: 0 }}
// //                   transition={{ delay: 0.4 }}
...
// //                   >
// //                     {/* 
// //                       [গাইড - ইমেজ উইড্থ ও সাইড স্পেসিং]:
// //                       'w-full' থাকার কারণে ইমেজটি ওপরের কন্টেইনারের পুরো সাইজ (Edge to Edge) লুফে নিচ্ছে। 
// //                       দুই পাশের ফাঁকা অংশকে আরও কমাতে বা বাড়াতে চাইলে ওপরের প্যারেন্ট ডিভের 'px-2 md:px-4' ক্লাসে পরিবর্তন আনুন।
// //                     */}
// //                     <div className="w-full rounded-xl md:rounded-[2rem] overflow-hidden shadow-[0_15px_45px_rgba(0,0,0,0.05)] border border-gray-100 bg-[#fbfbfb]">
// //                       <motion.img 
...
//   // প্রজেক্ট লিস্ট (আপনার রিকুয়েস্ট অনুযায়ী ইমেজ সিরিয়াল ও থাম্বনেইল আপডেট করা হয়েছে)
//   const projects = [
//     {
//       id: 1,
//       title: "CLIKTRO",
//       description: "Designing trust for decentralized commerce through modern aesthetics.",
//       tags: ["Brand Strategy", "Naming", "UI/UX"],
//       image: protfolio, // ১ম প্রজেক্টের মেইন থাম্বনেইল ইমেজ
//       gridSpan: "col-span-1",
//       previews: [protfolio, protfolio1, protfolio2], // ক্লিক করার পর সিরিয়াল অনুযায়ী ৩টি ইমেজ
//     },
//     {
//       id: 2,
//       title: "Robotic Implant Center",
//       description: "Positioning robotic dentistry as a category leader in healthcare.",
//       tags: ["Web Design", "Engineering", "Motion"],
//       image: protfolio3, // ২য় প্রজেক্টের মেইন থাম্বনেইল ইমেজ
//       gridSpan: "col-span-1",
//       previews: [protfolio3, protfolio4, protfolio5], // ক্লিক করার পর সিরিয়াল অনুযায়ী ৩টি ইমেজ
//     },
//   ];
...
//             {/* [গাইড - মডাল কন্টেইনার উইড্থ ও প্যাডিং]:
//               ইমেজগুলোকে ডেস্কটপের দুই পাশে একদম কম স্পেসিং দিয়ে ফুল উইড্থ করার জন্য 'max-w-none' এবং দুই পাশের প্যাডিং কমিয়ে 'px-2 md:px-4' করা হয়েছে।
//             */}
//             <div className="w-full max-w-none px-2 md:px-4 pt-12 pb-32">
//               {/* Intro Section */}
//               <div className="mb-24 md:mb-32 max-w-7xl mx-auto px-4 md:px-12">
...
//                     {/* [গাইড - ইমেজ উইড্থ ও সাইড স্পেসিং]:
//                       'w-full' থাকার কারণে ইমেজটি ওপরের কন্টেইনারের পুরো সাইজ (Edge to Edge) লুফে নিচ্ছে। 
//                       দুই পাশের ফাঁকা অংশকে আরও কমাতে বা বাড়াতে চাইলে ওপরের প্যারেন্ট ডিভের 'px-2 md:px-4' ক্লাসে পরিবর্তন আনুন।
//                     */}
//                     <div className="w-full rounded-xl md:rounded-[2rem] overflow-hidden shadow-[0_15px_45px_rgba(0,0,0,0.05)] border border-gray-100 bg-[#fbfbfb]">
//                       <motion.img 
//                         whileHover={{ scale: 1.005 }}
  ...
  const projects = [
    {
      ...
      image: protfolio, 
      gridSpan: "col-span-1",
      previews: [protfolio, protfolio1, protfolio2], 
    },
    {
      id: 2,
      title: "Robotic Implant Center",
      ...
      image: protfolio3, 
      gridSpan: "col-span-1",
      previews: [protfolio3, protfolio4, protfolio5], 
    },
  ];
      ...
      <AnimatePresence>
        {selectedProject && (
          ...
          >
            ...
            {/* মডাল কন্টেইনার উইড্থ ও সাইড প্যাডিং */}
            <div className="w-full max-w-none px-2 md:px-4 pt-12 pb-32">
              {/* Intro Section */}
              <div className="mb-24 md:mb-32 max-w-7xl mx-auto px-4 md:px-12">
                <motion.h2 
              ...
              {/* [গাইড - ইমেজগুলোর মাঝখানের গ্যাপ কমানো]:
                ইমেজগুলোর ওপর-নিচের স্পেসিং কমানোর জন্য এখানে 'space-y-12 md:space-y-20' থেকে পরিবর্তন করে 
                কমিয়ে 'space-y-4 md:space-y-6' করে দেওয়া হয়েছে।
              */}
