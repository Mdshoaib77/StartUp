...
//   return (
//     <section id="about" className="w-fullbg-[#f2f2f2] py-16 px-4 md:px-8">
...
const PurposeSection = () => {
  ...
  return (
    // এখানে bg-[#f2f2f2] এবং w-full নিশ্চিত করা হয়েছে যাতে পুরো স্ক্রিন কালার হয়
    <section id="about" className="w-full bg-[#f2f2f2] py-16 px-4 md:px-8">
      <div className="max-w-6xl mx-auto">
        <motion.div 
          variants={fadeIn('right', 0.2)}
          initial="hidden"
