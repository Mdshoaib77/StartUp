...
// // // //                 <div className="overflow-hidden">
// // // //                   <motion.div variants={fadeInUp} className="text-[52px]">
// // // //                     WHERE 
// // // //                   </motion.div>
// // // //                 </div>
// // // //                 <div className="overflow-hidden">
...
// // //           src={redbd}
// // //           alt=""
// // //           className="absolute left-[65%] top-[55%]
// // //           h-[500px] w-[500px]
// // //           md:h-[650px] md:w-[650px]
// // //           lg:h-[800px] lg:w-[800px]
// // //           -translate-x-1/2 -translate-y-1/2 object-contain opacity-80"
// // //         />
// // //       </motion.div>
...
// // //           {/* ✳︎ STAR (aligned with M + rotating) */}
// // //           <motion.div 
// // //             animate={{ rotate: 360 }}
...
// // //             initial="hidden"
// // //             animate="visible"
// // //             className="absolute left-0 top-[150px] md:left-[110px] md:top-[100px]"
// // //           >
// // //             <h1 className="font-semibold uppercase leading-[1] md:leading-[0.9] tracking-[-0.03em] text-black">
...
// // //                     FUTURES
// // //                   </motion.div>
// // //                   <motion.span className="text-[18px] ml-2">®</motion.span>
// // //                 </div>
// // //               </div>
...
// // //                   <motion.div 
// // //                     variants={fadeInUp}
// // //                     className="text-[52px] sm:text-[70px] md:text-[150px]"
// // //                   >
// // //                     WHERE IDEAS
// // //                   </motion.div>
...
// // //                     animate={{ rotate: 360 }}
// // //                     transition={{ duration: 20, repeat: Infinity, ease: "linear" }}
// // //                     className="text-[60px] md:text-[85px]"
// // //                   >
// // //                     ✳︎
// // //                   </motion.span>
// // //                 </div>
...
// // //                   <motion.div 
// // //                     variants={fadeInUp}
// // //                     className="text-[52px] sm:text-[70px] md:text-[150px] mt-[15px] md:mt-[25px] md:ml-[300px]"
// // //                   >
// // //                     SHAPE THE
// // //                   </motion.div>
// // //                 </div>
...
// // //                   <motion.div 
// // //                     variants={fadeInUp}
// // //                     className="text-[52px] sm:text-[70px] md:text-[150px] mt-[15px] md:mt-[25px] flex items-start"
// // //                   >
// // //                     FUTURES
// // //                     <motion.span className="text-[20px] sm:text-[26px] md:text-[40px] ml-2">
// // //                       ®
// // //                     </motion.span>
// // //                   </motion.div>
// // //                 </div>
...
// // //             animate={{ opacity: 0.4, x: 0 }}
// // //             transition={{ delay: 1.2, duration: 0.8 }}
// // //             className="absolute left-0 top-[420px] md:left-[127px] md:top-[290px]"
// // //           >
// // //             <p className="max-w-[320px] md:max-w-[660px] text-[13px] font-semibold uppercase leading-[1.5] tracking-[0.08em] text-black">
// // //               WE ARE STRATEGIC BRANDING <br />
// // //               DESIGN AGENCY HELPING <br />
// // //               THE PLANET  MOST COMPANIES<br />
// // //               MOVE FORWARDS.
...
// // //             animate={{ y: [0, 10, 0] }}
// // //             transition={{ duration: 3, repeat: Infinity }}
// // //             className="absolute bottom-8 right-6 md:bottom-10 md:right-2 cursor-pointer"
// // //           >
// // //             <span className="text-[12px] font-semibold uppercase tracking-[0.12em] text-black">
// // //               SCROLL DOWN
// // //             </span>
...
// // //             initial="hidden"
// // //             animate="visible"
// // //             className="absolute left-0 top-[150px] md:left-0 md:top-[100px]"
// // //           >
// // //             <h1 className="font-semibold uppercase leading-[1] md:leading-[0.9] tracking-[-0.03em] text-black">
...
// // //                   <motion.div 
// // //                     variants={fadeInUp}
// // //                     className="text-[52px] sm:text-[70px] md:text-[165px]"
// // //                   >
// // //                     WHERE IDEAS
// // //                   {/* </motion.div>
...
// // //                   <motion.div 
// // //                     variants={fadeInUp}
// // //                     className="text-[52px] sm:text-[70px] md:text-[165px] mt-[15px] md:mt-[25px] md:ml-[380px]"
// // //                   >
// // //                     SHAPE THE
// // //                   </motion.div>
// // //                 </div>
...
// // //                   <motion.div 
// // //                     variants={fadeInUp}
// // //                     className="text-[52px] sm:text-[70px] md:text-[165px] mt-[15px] md:mt-[25px] flex items-start"
// // //                   >
// // //                     FUTURES
// // //                     <motion.span className="text-[20px] sm:text-[26px] md:text-[40px] ml-2">
// // //                       ®
...
// // //             animate={{ opacity: 0.4, x: 0 }}
// // //             transition={{ delay: 1.2, duration: 0.8 }}
// // //             className="absolute left-0 top-[420px] md:left-0 md:top-[290px]"
// // //           >
// // //             <p className="max-w-[320px] md:max-w-[660px] text-[13px] font-semibold uppercase leading-[1.5] tracking-[0.08em] text-black">
// // //               WE ARE STRATEGIC BRANDING <br />
// // //               DESIGN AGENCY HELPING <br />
...
// //           {/* HEADLINE - UPDATED FOR MOBILE POSITION & SIZE */}
// //           <motion.div 
// //             variants={staggerContainer}
// //             initial="hidden"
// //             animate="visible"
// //             className="absolute left-0 top-[80px] md:left-0 md:top-[100px] w-full"
// //           >
// //             <h1 className="font-semibold uppercase leading-[0.9] md:leading-[0.9] tracking-[-0.03em] text-black w-full">

// //               {/* Mobile: 4 Lines, Higher Position, Fullscreen Width Fill */}
// //               <div className="md:hidden flex flex-col w-full">
// //                 <div className="overflow-hidden">
// //                   <motion.div variants={fadeInUp} className="text-[18vw] leading-none">
// //                     WHERE 
// //                   </motion.div>
// //                 </div>
...
// //                     FUTURES
// //                   </motion.div>
// //                   <motion.span className="text-[6vw] mt-2 ml-1">®</motion.span>
// //                 </div>
// //               </div>
...
// //           {/* PARAGRAPH - ADJUSTED POSITION FOR MOBILE */}
// //           <motion.div 
// //             initial={{ opacity: 0, x: -20 }}
// //             animate={{ opacity: 0.4, x: 0 }}
// //             transition={{ delay: 1.2, duration: 0.8 }}
// //             className="absolute left-0 top-[480px] md:left-0 md:top-[290px]"
// //           >
// //             <p className="max-w-[320px] md:max-w-[660px] text-[13px] font-semibold uppercase leading-[1.5] tracking-[0.08em] text-black">
// //               WE ARE STRATEGIC BRANDING <br />
// //               DESIGN AGENCY HELPING <br />
...
//             className="
//               absolute left-0 
//               top-[80px]       /* 🔥 was 150px → now less gap */
//               md:left-0 md:top-[100px]
//             "
//           >
//             <h1 className="font-semibold uppercase leading-[1] md:leading-[0.9] tracking-[-0.03em] text-black">
...
//                     className="text-[clamp(76px,14vw,90px)] leading-[0.95]">
//                     WHERE 
//                   </motion.div>
//                 </div>
...
//                     animate={{ rotate: 360 }}
//                     transition={{ duration: 20, repeat: Infinity, ease: "linear" }}
//                     className="text-[clamp(34px,6vw,40px)]"
//                   >
//                     ✳︎
//                   </motion.span>
//                 </div>
...
//                 <div className="overflow-hidden">
//                   <motion.div variants={fadeInUp} 
//                     className="text-[clamp(60px,14vw,90px)] leading-[0.95]">
//                     SHAPE  THE
//                   </motion.div>
//                 </div>
...
//                 <div className="overflow-hidden flex items-start">
//                   <motion.div variants={fadeInUp} 
//                     className="text-[clamp(72px,13vw,85px)] leading-[0.95]">
//                     FUTURES
//                   </motion.div>
//                   <motion.span className="text-[clamp(16px,4vw,24px)] ml-2 mt-1">®</motion.span>
//                 </div>
...
//             className="
//               absolute left-0 
//               top-[360px]   /* 🔥 was 420px → now tighter */
//               md:left-0 md:top-[290px]
//             "
//           >
//             <p className="mt-5 max-w-[320px] md:max-w-[660px] text-[23px] font-semibold uppercase leading-[1.5] tracking-[0.08em] text-black">
//               WE ARE STRATEGIC BRANDING <br />
//               DESIGN AGENCY HELPING <br />
//               THE PLANET  MOST COMPANIES<br />
//               MOVE FORWARDS.
        ...
        <div className="relative min-h-[calc(100vh-64px)] md:min-h-[calc(100vh-80px)]">
          ...
          >
            <h1 className="font-semibold uppercase leading-[0.9] md:leading-[0.9] tracking-[-0.03em] text-black w-full">
              ...
              {/* Mobile: "THE" moved to a new line after "SHAPE" */}
              <div className="md:hidden flex flex-col w-full">
                <div className="overflow-hidden">
                  <motion.div variants={fadeInUp} className="text-[22vw] leading-none">
                    WHERE 
                  </motion.div>
                </div>
                ...
                <div className="overflow-hidden flex items-center justify-between">
                  ...
                  <motion.span
                     animate={{ rotate: 360 }}
                      transition={{ duration: 20, repeat: Infinity, ease: "linear" }}
                    className="text-[12vw] relative -left-17 -top-4" // বামে (-left) এবং উপরে (-top) সরানোর জন্য
                                 >
                                  ✳︎
                              </motion.span>
                </div>

                {/* SHAPE and THE in separate lines */}
                <div className="overflow-hidden">
                  <motion.div variants={fadeInUp} className="text-[22vw] leading-none">
                    SHAPE
                  </motion.div>
          ...
          >
            <p className="max-w-[320px] mt-4 md:max-w-[660px] text-[15px] font-semibold uppercase leading-[1.5] tracking-[0.08em] text-black">
              WE ARE STRATEGIC BRANDING <br />
              DESIGN AGENCY HELPING <br />
              THE PLANET  MOST COMPANIES<br />
              MOVE FORWARDS.
          ...
          <motion.div 
            ...
            animate={{ y: [0, 10, 0] }}
            transition={{ duration: 3, repeat: Infinity }}
            className="absolute bottom-8 right-0 md:bottom-10 md:right-2 cursor-pointer"
          >
            <span className=" text-[12px] font-semibold uppercase tracking-[0.12em] text-black">
              SCROLL DOWN
            </span>
