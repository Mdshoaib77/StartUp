...
//   const socialLinks = [
//     { icon: <FaFacebookF />, link: "https://www.facebook.com/paxime" },
//     { icon: <FaLinkedinIn />, link: "https://www.linkedin.com/company/devators/?viewAsMember=true" },
//     { icon: <FaWhatsapp />, link: "https://wa.me/8801773545662?text=Hello%20Devators,%20I%20want%20to%20discuss%20a%20project." },
//   ];
          ...
          <div className="lg:col-span-3">
            ...
            <div className="space-y-6">
              <div className="group cursor-pointer">
                ...
                <p className="text-xl font-medium tracking-tight text-slate-900">hellodevators@gmail.com</p>
              </div>
