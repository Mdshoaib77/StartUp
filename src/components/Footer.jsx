...
//       whileInView="show"
//       viewport={{ once: true }}
//       className="bg-[#f2f2f2] w-full overflow-hidden border-t border-gray-200"
//     >
...
const Footer = () => {
  ...
  return (
    <motion.footer 
      ...
      whileInView="show"
      viewport={{ once: true }}
      className="relative bg-[#f2f2f2] w-full overflow-hidden" // ❌ border removed
    >

      {/* 🔥 SAME EXACT GRADIENT (Contact er sathe match) */}
      ...
      {/* Container */}
      <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-12 py-12 md:py-20">
          ...
          >
            ...
            >
              ...
              <motion.a 
                whileHover={{ scale: 1.1, y: -2 }}
                href="#" 
                className="w-10 h-10 bg-gray-200 rounded-full flex items-center justify-center text-gray-600 hover:bg-blue-400 hover:text-white transition-all shadow-sm"
              >
                <FaTwitter className="w-5 h-5" />
              </motion.a>
              <motion.a 
        ...
        {/* ❌ Bottom border removed for seamless */}
        <motion.div 
          variants={fadeIn('up', 0.8)}
